...
function BrandProcess(result){
    return new Promise(async (resolve,reject)=>{
        try {
            ...
            let brandNodeTag= await jsonToXMLParser.PrepareChildNode(brand_obj);
            writeStream.write(brandNodeTag);
            resolve(true);
        }
        catch (err) {
            reject(err.message);
