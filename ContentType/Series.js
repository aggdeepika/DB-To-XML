...
function SeriesProcess(result){
    return new Promise(async (resolve,reject)=>{
        try {
            ...
            let seriesNodeTag= await jsonToXMLParser.PrepareChildNode(series_obj);
            writeStream.write(seriesNodeTag);
            resolve(true);
        }
        catch (err) {
            reject(err.message);
