...
function shortsProcess(result){
    return new Promise(async (resolve,reject)=>{
        try {
            ...
            let shortsNodeTag= await jsonToXMLParser.PrepareChildNode(shorts_obj);
            writeStream.write(shortsNodeTag);
            resolve(true);
        }
        catch (err) {
            reject(err.message);
